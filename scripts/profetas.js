const url =
  "https://byui-cse.github.io/cse-ww-program-pt/data/profetas-dos-ultimos-dias.json";
...
const exibirProfetas = (profetas) => {
    ...
    profetas.forEach((profeta) => {
        ...
        nomeCompleto.textContent =
            `${profeta.nome} ${profeta.sobrenome}`;

        nascimento.innerHTML =
            `<strong>Nascimento:</strong> ${profeta.nascimento}<br>
             <strong>Local:</strong> ${profeta.localNascimento}`;
